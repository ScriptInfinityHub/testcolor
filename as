...
local aa = {
	...
	[48] = function()
		...
		return {
			Name = 'Violet Abyss',
			Accent = Color3.fromRGB(145, 22, 189), -- น้ำเงินเข้ม
			AcrylicMain = Color3.fromRGB(20, 20, 20), -- ดำลึก
			AcrylicBorder = Color3.fromRGB(35, 35, 35), -- ขอบดำเข้ม
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 20, 20),Color3.fromRGB(20, 20, 20)),
			AcrylicNoise = 0.8,
			TitleBarLine = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			Tab = Color3.fromRGB(145, 22, 189), -- น้ำเงินเข้ม
			Element = Color3.fromRGB(25, 25, 25), -- ดำลึก
			ElementBorder = Color3.fromRGB(35, 35, 35), -- ขอบดำเข้ม
			InElementBorder = Color3.fromRGB(35, 35, 35),
			ElementTransparency = 0,
			ToggleSlider = Color3.fromRGB(145, 22, 189), -- น้ำเงินเข้ม
			ToggleToggled = Color3.fromRGB(200, 200, 200), -- ขาวเทาสำหรับความชัดเจน
			SliderRail = Color3.fromRGB(35, 35, 35), -- รางสีดำเข้ม
			DropdownFrame = Color3.fromRGB(30, 30, 30), -- กล่องดำเข้ม
			DropdownHolder = Color3.fromRGB(30, 30, 30),
			DropdownBorder = Color3.fromRGB(20, 20, 20), -- ขอบดำลึก
			DropdownOption = Color3.fromRGB(145, 22, 189), -- น้ำเงินเข้ม
			Keybind = Color3.fromRGB(25, 25, 25), -- ดำลึก
			Input = Color3.fromRGB(15, 15, 15), -- ดำสนิท
			InputFocused = Color3.fromRGB(35, 35, 35), -- ดำเข้มเมื่อโฟกัส
			InputIndicator = Color3.fromRGB(100, 150, 200), -- น้ำเงินอ่อน
			Dialog = Color3.fromRGB(20, 20, 20), -- พื้นหลังดำลึก
			DialogHolder = Color3.fromRGB(30, 30, 30), -- กรอบดำเข้ม
			DialogHolderLine = Color3.fromRGB(35, 35, 35), -- เส้นขอบดำเข้ม
			DialogButton = Color3.fromRGB(25, 25, 25), -- ปุ่มดำลึก
			DialogButtonBorder = Color3.fromRGB(35, 35, 35),
			DialogBorder = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			DialogInput = Color3.fromRGB(15, 15, 15), -- กล่องข้อความดำสนิท
			DialogInputLine = Color3.fromRGB(145, 22, 189), -- เส้นน้ำเงินเข้ม
			Text = Color3.fromRGB(200, 200, 200), -- ขาวเทาอ่านง่าย
			SubText = Color3.fromRGB(150, 150, 150), -- ข้อความรองสีเทา
			Hover = Color3.fromRGB(58, 117, 196), -- น้ำเงินเข้มเมื่อชี้
			HoverChange = 0.04
		}
	...
	[49] = function()
		...
		return {
			...
			Accent = Color3.fromRGB(41, 162, 27), -- น้ำเงินเข้ม
			AcrylicMain = Color3.fromRGB(20, 20, 20), -- ดำลึก
			AcrylicBorder = Color3.fromRGB(35, 35, 35), -- ขอบดำเข้ม
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 20, 20),Color3.fromRGB(20, 20, 20)),
			AcrylicNoise = 0.8,
			TitleBarLine = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			Tab = Color3.fromRGB(41, 162, 27), -- น้ำเงินเข้ม
			Element = Color3.fromRGB(25, 25, 25), -- ดำลึก
			ElementBorder = Color3.fromRGB(35, 35, 35), -- ขอบดำเข้ม
			InElementBorder = Color3.fromRGB(35, 35, 35),
			ElementTransparency = 0,
			ToggleSlider = Color3.fromRGB(41, 162, 27), -- น้ำเงินเข้ม
			ToggleToggled = Color3.fromRGB(200, 200, 200), -- ขาวเทาสำหรับความชัดเจน
			SliderRail = Color3.fromRGB(35, 35, 35), -- รางสีดำเข้ม
			DropdownFrame = Color3.fromRGB(30, 30, 30), -- กล่องดำเข้ม
			DropdownHolder = Color3.fromRGB(30, 30, 30),
			DropdownBorder = Color3.fromRGB(20, 20, 20), -- ขอบดำลึก
			DropdownOption = Color3.fromRGB(41, 162, 27), -- น้ำเงินเข้ม
			Keybind = Color3.fromRGB(25, 25, 25), -- ดำลึก
			Input = Color3.fromRGB(15, 15, 15), -- ดำสนิท
			InputFocused = Color3.fromRGB(35, 35, 35), -- ดำเข้มเมื่อโฟกัส
			InputIndicator = Color3.fromRGB(100, 150, 200), -- น้ำเงินอ่อน
			...
			DialogBorder = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			DialogInput = Color3.fromRGB(15, 15, 15), -- กล่องข้อความดำสนิท
			DialogInputLine = Color3.fromRGB(41, 162, 27), -- เส้นน้ำเงินเข้ม
			Text = Color3.fromRGB(200, 200, 200), -- ขาวเทาอ่านง่าย
			SubText = Color3.fromRGB(150, 150, 150), -- ข้อความรองสีเทา
			Hover = Color3.fromRGB(58, 117, 196), -- น้ำเงินเข้มเมื่อชี้
			HoverChange = 0.04
	...
	[53] = function()
		...
		return {
			...
			DialogInputLine = Color3.fromRGB(255, 144, 168),
			Text = Color3.fromRGB(230, 230, 230),
			SubText = Color3.fromRGB(170, 170, 170),
			Hover = Color3.fromRGB(255, 144, 168),
			HoverChange = 0.04
		}
	...
	[54] = function()
		...
		return {
			Name = "Eclipse Gold",
			Accent = Color3.fromRGB(255, 214, 107),
    AcrylicMain = Color3.fromRGB(45, 45, 45),
    AcrylicBorder = Color3.fromRGB(60, 60, 60),
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(45, 45, 45), Color3.fromRGB(45, 45, 45)),
    AcrylicNoise = 0.6,
    TitleBarLine = Color3.fromRGB(80, 80, 80),
    Tab = Color3.fromRGB(255, 214, 107),
    Element = Color3.fromRGB(50, 50, 50),
    ElementBorder = Color3.fromRGB(70, 70, 70),
    InElementBorder = Color3.fromRGB(70, 70, 70),
    ElementTransparency = 0,
    ToggleSlider = Color3.fromRGB(255, 214, 107), 
    ToggleToggled = Color3.fromRGB(255, 255, 255),
    SliderRail = Color3.fromRGB(70, 70, 70),
    DropdownFrame = Color3.fromRGB(55, 55, 55),
    DropdownHolder = Color3.fromRGB(55, 55, 55),
    DropdownBorder = Color3.fromRGB(45, 45, 45),
    DropdownOption = Color3.fromRGB(255, 214, 107), 
    Keybind = Color3.fromRGB(50, 50, 50), 
    Input = Color3.fromRGB(40, 40, 40),
    InputFocused = Color3.fromRGB(70, 70, 70),
    InputIndicator = Color3.fromRGB(255, 214, 107),
    Dialog = Color3.fromRGB(45, 45, 45), 
    DialogHolder = Color3.fromRGB(60, 60, 60),
    DialogHolderLine = Color3.fromRGB(70, 70, 70),
    DialogButton = Color3.fromRGB(50, 50, 50),
    ...
    DialogInput = Color3.fromRGB(40, 40, 40), 
    DialogInputLine = Color3.fromRGB(255, 214, 107),
    Text = Color3.fromRGB(230, 230, 230), 
    SubText = Color3.fromRGB(170, 170, 170), 
    Hover = Color3.fromRGB(255, 224, 127), 
    HoverChange = 0.04
		}
	end,
	[55] = function()
	...
	[56] = function()
		...
		return {
			Name = 'Night Typewriter',
			Accent = Color3.fromRGB(25, 0, 45), -- น้ำเงินเข้ม
			AcrylicMain = Color3.fromRGB(20, 20, 20), -- ดำลึก
			AcrylicBorder = Color3.fromRGB(45, 60, 75), -- ขอบดำเข้ม
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 20, 20), Color3.fromRGB(20, 20, 20)),
			AcrylicNoise = 0.8,
			TitleBarLine = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			Tab = Color3.fromRGB(25, 0, 45), -- น้ำเงินเข้ม
			Element = Color3.fromRGB(25, 25, 25), -- ดำลึก
			ElementBorder = Color3.fromRGB(45, 60, 75), -- ขอบดำเข้ม
			InElementBorder = Color3.fromRGB(45, 60, 75),
			ElementTransparency = 0,
			ToggleSlider = Color3.fromRGB(25, 0, 45), -- น้ำเงินเข้ม
			ToggleToggled = Color3.fromRGB(200, 200, 200), -- ขาวเทาสำหรับความชัดเจน
			SliderRail = Color3.fromRGB(45, 60, 75), -- รางสีดำเข้ม
			DropdownFrame = Color3.fromRGB(30, 30, 30), -- กล่องดำเข้ม
			DropdownHolder = Color3.fromRGB(30, 30, 30),
			DropdownBorder = Color3.fromRGB(20, 20, 20), -- ขอบดำลึก
			DropdownOption = Color3.fromRGB(25, 0, 45), -- น้ำเงินเข้ม
			Keybind = Color3.fromRGB(25, 25, 25), -- ดำลึก
			Input = Color3.fromRGB(15, 15, 15), -- ดำสนิท
			InputFocused = Color3.fromRGB(45, 60, 75), -- ดำเข้มเมื่อโฟกัส
			InputIndicator = Color3.fromRGB(100, 150, 200), -- น้ำเงินอ่อน
			Dialog = Color3.fromRGB(20, 20, 20), -- พื้นหลังดำลึก
			DialogHolder = Color3.fromRGB(30, 30, 30), -- กรอบดำเข้ม
			DialogHolderLine = Color3.fromRGB(45, 60, 75), -- เส้นขอบดำเข้ม
			DialogButton = Color3.fromRGB(25, 25, 25), -- ปุ่มดำลึก
			DialogButtonBorder = Color3.fromRGB(45, 60, 75),
			DialogBorder = Color3.fromRGB(80, 80, 80), -- ขอบเทาเข้ม
			DialogInput = Color3.fromRGB(15, 15, 15), -- กล่องข้อความดำสนิท
			DialogInputLine = Color3.fromRGB(25, 0, 45), -- เส้นน้ำเงินเข้ม
			Text = Color3.fromRGB(200, 200, 200), -- ขาวเทาอ่านง่าย
			SubText = Color3.fromRGB(150, 150, 150), -- ข้อความรองสีเทา
			Hover = Color3.fromRGB(25, 0, 45), -- น้ำเงินเข้มเมื่อชี้
			HoverChange = 0.04
		}
	end,
	[58] = function()
